...
- The task requires offline vendor management, legal approval workflow ownership, or live production logistics.
...
4. End with a technical and policy review that marks every artifact as confirmed, inferred, blocked, or pending approval.
